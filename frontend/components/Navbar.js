...
export function Navbar() {
    ...
    return (
        <View style={styles.navbar} ref={viewRef} >
            ...
            {authenticated ? (
                <>
                    <Text style={[styles.optionsNavbar, pressed && styles.optionsNavbarPressed]} onPress={() => navigation.navigate("CreatePost")} onPressIn={onPressInHandle} >Criar Publicação</Text>
